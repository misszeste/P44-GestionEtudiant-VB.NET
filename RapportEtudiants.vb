...
Public Class RapportEtudiants
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "P44_TP1_2210116.RapportEtudiants.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRapportEtudiants
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RapportEtudiants = New RapportEtudiants()
        rpt.Site = Me.Site
        Return rpt
    End Function
