...
Public Class RapportEtudParProg
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "P44_TP1_2210116.RapportEtudParProg.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRapportEtudParProg
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RapportEtudParProg = New RapportEtudParProg()
        rpt.Site = Me.Site
        Return rpt
    End Function
