...
Public Class RapportProgrammes
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "P44_TP1_2210116.RapportProgrammes.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRapportProgrammes
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RapportProgrammes = New RapportProgrammes()
        rpt.Site = Me.Site
        Return rpt
    End Function
